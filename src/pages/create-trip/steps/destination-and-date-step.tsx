...
interface DestinationAndDateStepProps {
  ...
  setEventsStartAndEndDates: (data: DateRange | undefined) => void;
...
export function DestinationAndDateStep({
  ...
  const [isDatePickerOpen, setIsOpenDatePicker] = useState(false);
  ...
  return (
    <div className="h-16 px-4 bg-zinc-900 rounded-xl flex items-center shadow-shape gap-3">
      ...
      >
        ...
        <span className="bg-transparent text-lg text-zinc-400 w-40 flex-1 outline-none">
